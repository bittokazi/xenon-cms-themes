...
iu=15;
document.getElementById("atext").innerHTML = 'سەە مۆرە';
var xmlhttp;
...
xmlhttp.open("POST","http://<?php echo @$_SERVER['SERVER_NAME']; ?>/core?action=searchfurrat",true);
...
if (window.XMLHttpRequest)
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
	if(xmlhttp.responseText=="no") {
		document.getElementById("atext").innerHTML = '<div style=\"float:left; margin-left:10px;\">نۆتهينگ فۆوند</div>';
	}
	else {
...
while($pages = @mysql_fetch_array($result)) {
echo'
<div style="cursor:pointer" class="category_page_img_main show_hide3"><a href="'.home_url().'/ku/category/'.$pages['id'].'">
...
<div class="category_img_name" style="cursor:pointer">'.$pages['kuname'].'</div></a></div>';
}
}
	 } 
	 else {
...
echo'<div style="float:right; text-align:right; margin-right: 0px; margin-top:10px;">&nbsp; : بەدواگەڕان  </div><div style="float:right; text-align:right;"><input type="text" id="en" value="" style="height: 40px; width:200px; border: 1px solid #b4b3b3; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px;"  onkeyup="searchFurrat()"/></div>';

echo'<div style="float:right; text-align:right;  margin-top:10px;">&nbsp; : شار هەڵ ببژێرە  &nbsp;</div><div style="float:right; text-align:right;"><select id="city" style="height: 40px; width:205px; margin-left:10px; border: 1px solid #b4b3b3; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px;" onchange="searchFurrat()">';
...
echo'<div style="float:right; text-align:right; margin-right: 20px;  margin-top:10px;">: خولەك ($) </div><div style="float:right; text-align:right;"><input type="text" id="min" value="" style="height: 40px; width:200px; border: 1px solid #b4b3b3; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px;"  onkeyup="searchFurrat()"/></div>';
...
echo'<br><br>';
echo'<div id="com" style="float:right; text-align:right; margin-top:30px;"><div style="float:right; text-align:right;  margin-top:10px;">&nbsp;&nbsp&nbsp; : كۆمپانيا &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div style="float:right; text-align:right;"><select onchange="searchFurrat()" id="showcom1" style="height: 40px; width:200px; margin-left:19px; border: 1px solid #b4b3b3; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px;">';
...
</script><div id="new_arival">        <div class="inttext" id="intext">        <span class="seelink"><a id="atext" style="cursor:pointer; color:white; text-decoration:none;" onclick="searchFurratmore()">سەە مۆرە</a></span></div></div><div id="kurdshopping_show_more" style="display:none;">   
