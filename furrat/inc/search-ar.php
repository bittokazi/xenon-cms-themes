...
<div class="Kurdshopping_search" style="width:175px;height:52px;float:left; margin-right: 10px;">
...
?>" value="" style="border-radius: 0px 5px 5px 0px !important;"></input></div>

<button type="button" class="Kurdshopping_serch_text" style="background: #b5bdc8; /* Old browsers */
...
width:80px !important; margin-left:12px; border-radius: 5px 0px 0px 5px; margin-right: 0px; */
