    ...
    <div id="templatemo_main_sb">
        ...
        <div id="content">
			...
			<div style="float:left; clear:both; width:580px;" class="content_box">
                ...
                <p style="float:left; width: 350px;" align="justify">Posted on: '.the_date().' | '.the_time().'<br>Category: <a style="color:white; " href="'.the_category_link().'">'.the_category().'</a><br><em><p style="clear:both;">';
